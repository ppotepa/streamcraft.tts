                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                            ...
                            >
                                <div className="flex items-start justify-between mb-2">
                                    <span className="text-cyan-400 font-semibold">🤖 Automatic Flow</span>
                                    {sanitizeMode === 'auto' && (
                                        <span className="px-2 py-0.5 rounded-full bg-accent/20 text-accent text-xs">✓ Selected</span>
                                    )}
                                </div>
                            ...
                            >
                                <div className="flex items-start justify-between mb-2">
                                    <span className="text-amber-400 font-semibold">🎯 Manual Flow</span>
                                    {sanitizeMode === 'voice' && (
                                        <span className="px-2 py-0.5 rounded-full bg-amber-500/20 text-amber-400 text-xs">✓ Selected</span>
                                    )}
                                </div>
                    ...
                    <div className={shellClasses + ' p-4 space-y-3 animate-fadeIn'} style={{ animationDelay: '0.1s' }}>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            >
                                ...
                                <option value="Strict">🎯 Strict (max cleanup)</option>
                                <option value="Lenient">🌊 Lenient (preserve more)</option>
                            </select>
                            ...
                            <div className="rounded-lg border border-accent/30 bg-slate-950/70 p-4 space-y-3">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-2 text-xs">
                                    ...
                                    <div className="rounded-lg border border-slate-800 bg-slate-900/60 px-2 py-1.5">
                                        ...
                                        <p className="text-slate-100 font-mono text-sm">{sanitizeSegmentProgress && sanitizeSegmentProgress >= 100 ? 'finishing' : '…'}</p>
                                    </div>
                                    <div className="rounded-lg border border-slate-800 bg-slate-900/60 px-2 py-1.5">
                                    ...
                                    <div className="rounded-lg border border-slate-800 bg-slate-900/60 px-2 py-1.5">
                                        ...
                                        <p className="text-slate-100 font-mono text-sm">…</p>
                                    </div>
                                </div>
                                {/* Mini Preview Panel */}
